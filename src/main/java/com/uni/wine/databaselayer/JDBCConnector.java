package com.uni.wine.databaselayer;
        ...
        try (Statement stmt = conn.createStatement()) {
            ...
            String createWinesQuery =
                    "CREATE TABLE IF NOT EXISTS WINES(" +
                            ...
                            "FOREIGN KEY(id_grape) REFERENCES GRAPES(id_grape) ON DELETE CASCADE," +
            ...
            String createBottledWineQuery =
                    "CREATE TABLE IF NOT EXISTS BOTTLED_WINE(" +
                            ...
                            "FOREIGN KEY(id_wine) REFERENCES WINES(id_wine) ON DELETE CASCADE,"+
                            "FOREIGN KEY(bottle_volume) REFERENCES BOTTLES(bottle_volume),"+
                            "FOREIGN KEY(id_user) REFERENCES USERS(id_user) ON DELETE CASCADE)";
